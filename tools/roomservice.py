...
if not depsonly:
    print "Device %s not found. Attempting to retrieve device repository from Classicnerd Github (http://github.com/Classicnerd)." % device
...
def fetch_dependencies(repo_path):
    ...
    dependencies_path = repo_path + '/cn.dependencies'
    syncable_repos = []
...
print "Repository for %s not found in the Classicnerd Github repository list. If this is in error, you may need to manually add it to your local_manifest.xml." % device
